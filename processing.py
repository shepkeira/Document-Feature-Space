...
# output: word with only alphabetic characters (non alphabetic characters are removed)
...
# output: an array of words with only alphabetic characters
...
def remove_special_characers_from_phrase(phrase):
    ...
    no_contraction_words = remove_contractions(phrase)
...
def process_file(file_contents):
    ...
    for phrase in split_file:
        words_in_phrase = re.split(' ', phrase)
        ...
        final_phrase = remove_special_characers_from_phrase(words_in_phrase)
